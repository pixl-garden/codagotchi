var app = (function (Main_svelte) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 48, 16, 1694);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 46, 8, 1626);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 44, 0, 1561);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    		...
    		window.addEventListener('message', async event => {
    			...
    			if (message.type === 'image-uris') {
    				...
    				await preloadAllSpriteSheets().then(() => {
    					const unsubscribe = Main_svelte.spriteStore.subscribe(sprites => {
    	...
    	$$self.$capture_state = () => ({
    		...
    		images,
    		spriteStore: Main_svelte.spriteStore,
    		SCREENWIDTH,
    		width,
    		height,
    		padding,
