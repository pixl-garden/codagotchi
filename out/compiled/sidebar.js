var app = (function () {
    ...
    async function getGrid() {
    	return await createGridFromImage(img);
    }
    ...
    // (73:8) {#each row as cell, colIndex}
    function create_each_block_1(ctx) {
    	let div;
    	let each_value_1 = /*each_value_1*/ ctx[22];
    	let colIndex = /*colIndex*/ ctx[23];
    	const assign_div = () => /*div_binding*/ ctx[7](div, each_value_1, colIndex);
    	const unassign_div = () => /*div_binding*/ ctx[7](null, each_value_1, colIndex);

    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "pixel");
    			set_style(div, "background-color", /*cell*/ ctx[21].color);
    			add_location(div, file, 73, 12, 2229);
    		},
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*$gridStore*/ 1) {
    				set_style(div, "background-color", /*cell*/ ctx[21].color);
    			}

    			if (each_value_1 !== /*each_value_1*/ ctx[22] || colIndex !== /*colIndex*/ ctx[23]) {
    				unassign_div();
    				each_value_1 = /*each_value_1*/ ctx[22];
    				colIndex = /*colIndex*/ ctx[23];
    				assign_div();
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(73:8) {#each row as cell, colIndex}",
    		ctx
    	});
    ...
    // (72:4) {#each $gridStore as row, rowIndex}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:4) {#each $gridStore as row, rowIndex}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*$gridStore*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 64, 4, 1842);
    			add_location(button1, file, 65, 4, 1907);
    			add_location(button2, file, 66, 4, 1972);
    			add_location(button3, file, 67, 4, 2037);
    			attr_dev(div0, "class", "button-row");
    			add_location(div0, file, 63, 0, 1812);
    			attr_dev(div1, "class", "grid-container");
    			add_location(div1, file, 70, 0, 2107);
    			add_location(button4, file, 79, 4, 2402);
    			add_location(button5, file, 80, 4, 2464);
    			add_location(button6, file, 81, 4, 2526);
    			add_location(button7, file, 82, 4, 2588);
    			attr_dev(div2, "class", "button-row bottom-row");
    			add_location(div2, file, 78, 0, 2361);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button6, "click", /*click_handler_6*/ ctx[10], false, false, false, false),
    					listen_dev(button7, "click", /*click_handler_7*/ ctx[11], false, false, false, false)
    				];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, gridStore, value => $$invalidate(0, $gridStore = value));
    	...
    	$$self.$inject_state = $$props => {
    		if ('gridStore' in $$props) $$invalidate(1, gridStore = $$props.gridStore);
