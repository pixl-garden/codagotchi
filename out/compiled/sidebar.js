var app = (function () {
    ...
    // (83:8) {#each row as cell, colIndex}
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 83, 12, 2712);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(83:8) {#each row as cell, colIndex}",
    		ctx
    	});
    ...
    // (82:4) {#each $gridStore as row, rowIndex}
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(82:4) {#each $gridStore as row, rowIndex}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file, 73, 4, 2283);
    			add_location(button1, file, 74, 4, 2348);
    			add_location(button2, file, 75, 4, 2413);
    			add_location(button3, file, 76, 4, 2478);
    			attr_dev(div0, "class", "button-row");
    			add_location(div0, file, 72, 0, 2253);
    			if (!src_url_equal(img.src, img_src_value = /*$images*/ ctx[0]['pet.png'])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "1");
    			add_location(img, file, 78, 0, 2544);
    			attr_dev(div1, "class", "grid-container");
    			add_location(div1, file, 80, 0, 2590);
    			add_location(button4, file, 89, 4, 2885);
    			add_location(button5, file, 90, 4, 2947);
    			add_location(button6, file, 91, 4, 3009);
    			add_location(button7, file, 92, 4, 3071);
    			attr_dev(div2, "class", "button-row bottom-row");
    			add_location(div2, file, 88, 0, 2844);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let screens = { Screen1: getGrid$1, Screen2: getGrid }; // Screen3: getGrid3
