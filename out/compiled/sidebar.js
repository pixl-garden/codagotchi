var app = (function () {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "background-color", /*cell*/ ctx[11] ? 'white' : 'transparent');
    			add_location(div, file, 48, 16, 1632);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 46, 8, 1564);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(46:4) {#each screen as row}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 43, 0, 1444);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('sprite1' in $$props) sprite1 = $$props.sprite1;
    		if ('sprite2' in $$props) sprite2 = $$props.sprite2;
